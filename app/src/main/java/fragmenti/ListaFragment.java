...
public class ListaFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        expandableListDetalji.put(obKategorije.get(0).getNaziv(),obKategorije.get(0).getJela());
        expandableListDetalji.put(obKategorije.get(1).getNaziv(),obKategorije.get(1).getJela());
        expandableListDetalji.put(obKategorije.get(2).getNaziv(),obKategorije.get(2).getJela());
